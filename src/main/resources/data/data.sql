...
insert into todo(title, description, status, expires) VALUES ('Buy jotter today', 'Shopping', 'New', strftime('%Y-%m-%d','now'));
insert into todo(title, description, status, expires) VALUES ('Buy pencil today', 'Shopping', 'New', strftime('%Y-%m-%d','now'));
insert into todo(title, description, status, expires) VALUES ('Buy pencil today', 'Shopping', 'New', strftime('%Y-%m-%d','now'));
insert into todo(title, description, status, expires) VALUES ('Buy pencil today', 'Shopping', 'New', strftime('%Y-%m-%d','now'));
